...
export function SpeedRound({ user, soundEnabled, onBack, onLogout }) {
  ...
  useEffect(() => {
    const handleVisibilityChange = () => {
      if (document.hidden && gameStateRef.current === 'playing' && currentQuestionRef.current && !hasAnsweredRef.current) {
